...
def train(hyp):
    ...
    best = wdir + "best.pt"
    results_file = "runs/results{}.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
            ...
            if opt.savebest is False:
                ...
                with open(results_file, 'r') as f:
                    save_files = {
                        ...
                        'epoch': epoch,
                        'best_map': best_map}
                    torch.save(save_files, "./weights/yolov3_tiny_024.pt".format(epoch))
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tiny_dlh.cfg', help="*.cfg path")
